firstly, download the chrome driver from: https://sites.google.com/chromium.org/driver/downloads, unzip it and copy the chromedriver /usr/local/bin/ or to /usr/bin/.
